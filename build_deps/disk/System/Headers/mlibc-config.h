...
#define __MLIBC_LINUX_EPOLL_OPTION 0
#define __MLIBC_LINUX_TIMERFD_OPTION 0
#define __MLIBC_LINUX_SIGNALFD_OPTION 0
#define __MLIBC_LINUX_EVENTFD_OPTION 0
#define __MLIBC_LINUX_REBOOT_OPTION 0
#define __MLIBC_POSIX_OPTION 1
#define __MLIBC_LINUX_OPTION 0
#define __MLIBC_GLIBC_OPTION 0
#define __MLIBC_LINUX_WRAPPERS_OPTION 0
