...
impl Framebuffer {
    ...
    pub fn pixels(&self) -> &[u32] { unsafe { slice::from_raw_parts(self.pixel_ptr, self.size_in_bytes / 4) } }

    pub fn pixels_mut(&self) -> &mut [u32] { unsafe { slice::from_raw_parts_mut(self.pixel_ptr, self.size_in_bytes / 4) } }
